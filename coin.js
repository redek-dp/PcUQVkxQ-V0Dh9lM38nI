    ...
    var CoinWidgetCom = {
        ...
        window_position: function ($instance) {
            ...
            if (jQuery(coin_window).is(':visible')) {
                jQuery(coin_window).stop().animate({
                    'z-index': 99999999999,
                    'top': $top,
                    'left': $left
                }, 150);
            } else {
                jQuery(coin_window).stop().css({
                    'z-index': 99999999998,
                    'top': $top,
                    'left': $left
                });
        ...
        show: function (obj) {
            ...
            $config = CoinWidgetCom.config[$instance];
            coin_window = "#COINWIDGETCOM_WINDOW_" + $instance;
            jQuery(".COINWIDGETCOM_WINDOW").css({
                'z-index': 99999999998
            });
            if (!jQuery(coin_window).length) {
                ...
                $html = '' +
                    ...
                    '<a class="COINWIDGETCOM_CREDITS" href="http://000000000.com/" target="_blank">000000.com</a>' +
            ...
            jQuery(coin_window).find('img.COINWIDGET_INPUT_ICON').css({
                'top': $pos.top + 3,
                'left': $pos.left + 3
            });
            jQuery(coin_window).find('.COINWIDGETCOM_WALLETURI').css({
                'top': $pos.top + 3,
                'left': $pos.left + jQuery(coin_window).find('input').outerWidth() + 3
            });
            if ($config.counter != 'hide') {
